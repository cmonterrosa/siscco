...
#  self.bad_login_message = "use solo letras, numeros, y .-_@ por favor".freeze
...
#  self.bad_email_message = "should look like an email address.".freeze
  self.bad_email_message = "debe ser similar a una dirección de correo electrónico".freeze
